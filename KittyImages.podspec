...
Pod::Spec.new do |s|
  s.name             = 'KittyImages'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KittyImages.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Viktor Vrchlavský/KittyImages'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Viktor Vrchlavský' => 'viktor.vrchlavsky@applifting.cz' }
  s.source           = { :git => 'https://github.com/Viktor Vrchlavský/KittyImages.git', :tag => s.version.to_s }
